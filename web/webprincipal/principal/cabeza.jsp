      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <%---INICIO SEGUNDA---%>
            <li class="dropdown"><a href="../persona/index.jsp">PERSONA</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="../servletJSP/controlBienvenida.jsp?opcion=producto">PRODUCTOS</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="../servletJSP/controlBienvenida.jsp?opcion=producto">PROVEEDOR</a></li>
          </ul>
        </li>
         <li class="dropdown">
          <a href="#" class="dropdown-toggle glyphicon glyphicon-eye-open" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> VISTAS<span class="caret"></span></a>
          <ul class="dropdown-menu">
