<%@page import="bean.Hist_diagnost_def"%>
<%@page import="dao.Hist_diagnost_defDao"%>
<%@page import="daoimpl.Hist_diagnost_defDaoImpl"%>
<%@page import="bean.Diagnostico_pre"%>
<%@page import="daoimpl.Diagnostico_preDaoImpl"%>
<%@page import="dao.Diagnostico_preDao"%>
<%@page import="daoimpl.EmbarazoDaoImpl"%>
<%@page import="dao.EmbarazoDao"%>
<%@page import="bean.Embarazo"%>
<%@page import="bean.Hist_hab_noc"%>
<%@page import="daoimpl.Hist_hab_nocDaoImpl"%>
<%@page import="dao.Hist_hab_nocDao"%>
...
<%@page import="dao.Hist_ante_personalDao"%>
<%@page import="daoimpl.Hist_ante_personalDaoImpl"%>
...
<%
    ...
    if (!Nombres.equals("")) {
      ...
      response.sendRedirect("form_cliente.jsp?mensaje=SE AGREGO LA  HISTORIA CLINICA CORRECTAMENTE&alert=success&accion=bien");
                request.getAttribute("alert,success");
                request.getAttribute("estado,bien");
                
            } else {
      response.sendRedirect("form_cliente.jsp?mensaje=Ocurrio un error al agregar historia clinica&alert=danger&accion=mal");
                request.getAttribute("alert,danger");
                request.getAttribute("estado,mal");
            }
        } else {
            response.sendRedirect("form_cliente.jsp?mensaje=Ocurrio un error al agregar al cliente&alert=danger&accion=mal");
                request.getAttribute("alert,danger");
                request.getAttribute("estado,mal");
